...
class PidController(Node):
    ...
    def update_angle(self, error, dt):
    ...
    def msg_callback(self, msg):
        ...
        left_readings = []
        for i in range(int(one_deg * 15),
                       int(one_deg * 75)):  # Prior Values: for i in range(int(one_deg*10), int(one_deg*70)):
        ...
        # straight hallway scenario
            ...
            print('Error: %f' % error)
            self.angle = -self.update_angle(error, 0.1)
